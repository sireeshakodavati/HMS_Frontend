...
constructor(private jwtService:JwtclientService,private router:Router){}
 ...
 public getAccessToken(authRequest:any){
  ...
  let response =  this.jwtService.getDoctorGeneratedToken(authRequest);
 ...
 let response =    this.jwtService.authorizationTest(token);
       ...
       response.subscribe( responseData => {this.response = responseData; console.log(responseData) ; console.log(token); this.navigatetopatientdashboard();});
